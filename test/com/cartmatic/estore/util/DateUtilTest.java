...
public class DateUtilTest extends TestCase {
    ...
    public void testGetStartOfLastWeek()
    {
        System.out.println(DateUtil.getStartOfLastWeek());
    }
    
    public void testGetEndOfLastWeek()
    {
        System.out.println(DateUtil.getEndOfLastWeek());
    }
