...
public class TransferRecordController extends GenericController<TransferRecord> {
	 ...
	 */
	@Override
	protected String getEntityName(TransferRecord entity) {
		return entity.getTransferRecordName();
	}
	 ...
	 */
	@Override
	protected void onSave(HttpServletRequest request, TransferRecord entity, BindException errors) {
	}
