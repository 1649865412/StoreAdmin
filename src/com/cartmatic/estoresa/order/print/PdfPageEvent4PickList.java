...
public class PdfPageEvent4PickList extends PdfPageEvent {
	...
	public void onStartPage(PdfWriter writer, Document document) {
			...
			try {
	            ...
	            font.setSize(10);
	            head.addCell(new Phrase(this.getMessage("order.pdf.pickList"), font));
	...
	public void onEndPage(PdfWriter writer, Document document) {
        ...
        cb.setTextMatrix(document.right()-120, document.bottom() - 25);
        cb.showText(getMessage("orderPickList.signing"));
        cb.endText();
	...
	public void onCloseDocument(PdfWriter writer, Document document) {
       ...
       tpl.showText(" "+Integer.toString(writer.getPageNumber() - 1)+" "+getMessage("order.pdf.pageInfo1"));
       tpl.endText();
    }
