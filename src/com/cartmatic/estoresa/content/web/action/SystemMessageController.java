...
public class SystemMessageController extends GenericController<SystemMessage> {
    private SystemMessageManager systemMessageManager = null;

    public void setSystemMessageManager(SystemMessageManager inMgr) {
        this.systemMessageManager = inMgr;
    }
	...
	protected String getEntityName(SystemMessage entity) {
		return entity.getSystemMessageName();
	}
	 ...
	 */
	@Override
	protected void onSave(HttpServletRequest request, SystemMessage entity, BindException errors) {
	}
