...
public class CurrencyController extends GenericController<Currency> {
    ...
    public void setCurrencyManager(CurrencyManager inMgr) {
        this.currencyManager = inMgr;
    }
	 ...
	 */
	@Override
	protected String getEntityName(Currency entity) {
	 ...
	 */
	@Override
	protected void onSave(HttpServletRequest request, Currency entity, BindException errors) {
	}
