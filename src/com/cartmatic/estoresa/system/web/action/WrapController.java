...
public class WrapController extends GenericController<Wrap> {
    private WrapManager wrapManager = null;

    public void setWrapManager(WrapManager inMgr) {
        this.wrapManager = inMgr;
    }
	 ...
	 */
	@Override
	protected String getEntityName(Wrap entity) {
		return entity.getWrapName();
	}
	 ...
	 */
	@Override
	protected void onSave(HttpServletRequest request, Wrap entity, BindException errors) {
	}
