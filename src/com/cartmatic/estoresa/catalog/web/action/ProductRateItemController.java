...
public class ProductRateItemController extends GenericController<ProductRateItem> {
	 ...
	 */
	@Override
	protected String getEntityName(ProductRateItem entity) {
		return entity.getProductRateItemName();
	}
	 ...
	 */
	@Override
	protected void onSave(HttpServletRequest request, ProductRateItem entity, BindException errors) {
	}
