...
public class ProductPackageItemController extends GenericController<ProductPackageItem> {
	 ...
	 */
	@Override
	protected String getEntityName(ProductPackageItem entity) {
		return entity.getProductPackageItemName();
	}
	 ...
	 */
	@Override
	protected void onSave(HttpServletRequest request, ProductPackageItem entity, BindException errors) {
	}
