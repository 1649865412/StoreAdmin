...
public interface ShoppingcartManager extends GenericManager<Shoppingcart> {
	 ...
	 * @return
	 */
	public Shoppingcart addQuantityOne(String cartUuid, Integer productSkuId, String accessoryIds, HttpServletRequest request, HttpServletResponse response) throws Exception;
	...
	/**
	 *  卷控码验证，成功验证返回true，反之falselse
	 * <p>作者 杨荣忠 2015-5-18 下午02:28:35
	 * @param number
	 * @return
	 */
