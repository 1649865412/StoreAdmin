...
public class OrderConstants {
	...
	/**订单状态*/
	public final static Short ORDER_STATUS_IN_PROGRESS = new Short("10");     //正在进行
	public final static Short ORDER_STATUS_PARTIALLY_SHIPPED = new Short("20"); //部分支付
	public final static Short ORDER_STATUS_COMPLETE = new Short("30");    //完成
	public final static Short ORDER_STATUS_AWAITING_RETURN = new Short("40");  //  等待退款
