...
public class ProductPersistenceHandlerImpl implements PersistenceHandler{
	...
	public void saveOrUpdate(ImportModel importModel) {
		...
		if(mediaUrls!=null){
			...
			productMediaManager.saveProductMedias(product.getProductId(), productMediaIds,productMediaTypes, mediaUrls, mediaUrls_d, mediaDescriptions,productMedia_deleteds);
