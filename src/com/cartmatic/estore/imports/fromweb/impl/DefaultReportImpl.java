...
public class DefaultReportImpl implements ISpiderReportable 
{
	private Logger logger = Logger.getLogger(DefaultReportImpl.class);
	...
	public boolean spiderFoundURL(URL base, URL url)
	{
		...
		//only parse *.html;
		if (Downloader.LIB_PRODUCT_URL_PAT.matcher(strUrl).matches())
		{
				return true;
		}
		return false;
