...
public class ShoesReportImpl  implements ISpiderReportable
{
	private Logger logger = Logger.getLogger(ShoesReportImpl.class);
	...
	public boolean spiderFoundURL(URL base, URL url)
	{
		...
		//only parse *.html;
		if (Downloader.SHOES_PRODUCT_URL_PAT.matcher(strUrl).matches())
		{
			return true;
		}
		return false;
