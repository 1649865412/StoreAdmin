...
public class WatchReportImpl implements ISpiderReportable{
	
	private Logger logger = Logger.getLogger(WatchReportImpl.class);
	...
	public boolean spiderFoundURL(URL base, URL url)
	{
		...
		//only parse *.html;
		if (Downloader.WATCH_PRODUCT_URL_PAT.matcher(strUrl).matches())
		{
			return true;
		}
		return false;
