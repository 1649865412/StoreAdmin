...
public class SdReportImpl implements ISpiderReportable
{
	private Logger logger = Logger.getLogger(SdReportImpl.class);
	...
	public boolean spiderFoundURL(URL base, URL url)
	{
		...
		//only parse *.html;
		if (Downloader.SD_PRODUCT_URL_PAT.matcher(strUrl).matches())
		{
			return true;
		}
		return false;
