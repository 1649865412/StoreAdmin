...
public class CustomerTbl extends AppUser implements Serializable {
	...
	//判断用户是不是来招商银行旗下的任性支付用户
	protected String cmbeHomeUser;
	
	//判断用户是不是来招商银行旗下的任性支付用户Token
	protected String cmbeHome;
	

	public String getCmbeHomeUser() {
		return cmbeHomeUser;
	}

	public void setCmbeHomeUser(String cmbeHomeUser) {
		this.cmbeHomeUser = cmbeHomeUser;
	}

	public String getCmbeHome() {
		return cmbeHome;
	}

	public void setCmbeHome(String cmbeHome) {
		this.cmbeHome = cmbeHome;
	}
