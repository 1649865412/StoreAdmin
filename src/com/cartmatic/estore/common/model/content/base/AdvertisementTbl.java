...
public class AdvertisementTbl extends BaseObject implements Serializable {
	...
	protected String mediaPathMpFour;
	protected String mediaPathOgv;
	protected String mediaPathMpWebm;
	...
	public Integer getShowContext() {
		return showContext;
	}

	public void setShowContext(Integer showContext) {
	...
	public Integer getContextBackColor() {
		return contextBackColor;
	}

	public void setContextBackColor(Integer contextBackColor) {
		this.contextBackColor = contextBackColor;
	}
	...
	public String getMediaPathMpFour() {
		return mediaPathMpFour;
	}

	public void setMediaPathMpFour(String mediaPathMpFour) {
		this.mediaPathMpFour = mediaPathMpFour;
	}

	public String getMediaPathOgv() {
		return mediaPathOgv;
	}

	public void setMediaPathOgv(String mediaPathOgv) {
		this.mediaPathOgv = mediaPathOgv;
	}

	public String getMediaPathMpWebm() {
		return mediaPathMpWebm;
	}

	public void setMediaPathMpWebm(String mediaPathMpWebm) {
		this.mediaPathMpWebm = mediaPathMpWebm;
	}
	...
	public boolean equals(Object object) {
		...
		return new EqualsBuilder()
				...
				.append(this.mediaPathMpFour, rhs.mediaPathMpFour)
				.append(this.mediaPathOgv, rhs.mediaPathOgv)
				.append(this.mediaPathMpWebm, rhs.mediaPathMpWebm)
	...
	public String toString() {
		return new ToStringBuilder(this)
				...
				.append("mediaPathMpFour", this.mediaPathMpFour)
				.append("mediaPathOgv", this.mediaPathOgv) 
				.append("mediaPathMpWebm", this.mediaPathMpWebm) 
				.append("url", this.url) 
