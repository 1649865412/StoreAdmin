...
public class URLFormat
{
     ...
     * @since 1.4
     */
    public static String format(String s) throws UnsupportedEncodingException
    {
        String enc = "UTF-8";
        ...
        for (int i = 0; i < s.length();)
        {
            ...
            else
            {
                ...
                for (int j = 0; j < ba.length; j++)
                {
                     ...
                     * converting to use uppercase letter as part of // the hex
                     * value if ch is a letter. if (Character.isLetter(ch)) { ch
                     * -= caseDiff; } out.append(ch); ch =
                     * Character.forDigit(ba[j] & 0xF, 16); if
                     * (Character.isLetter(ch)) { ch -= caseDiff; }
                     * out.append(ch);
                     */
                }
